      ...
      {!allModule || allModule.length === 0 ? (
        ...
        <div className="flex gap-5 flex-wrap mt-2 real">
          {allModule.map((curr: IModule, index: number) => (
            ...
            >
              {index === 0 && (
                <div className="absolute top-1 right-1 bg-gradient-to-br from-orange-500 to-purple-500 text-white font-semibold  rounded shadow-xl z-50">
                  <p className="mx-2 my-1 font-normal">Best Match</p>
                </div>
              )}

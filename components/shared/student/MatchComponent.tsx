...
import { Component, IndianRupee, Navigation } from "lucide-react";
...
import ModuleComponent from "../services/ModuleComponent";
...
const MatchComponent = ({
  ...
  const [orgCategoryName, setOrgCategoryName] = useState<any>(null);
  ...
  const handleRes = () => {
    const data = {
      ...
      ModuleCateValue: ModuleCateValue,
      AmmountRange: AmmountRange,
      isFree: isFree,
      additniolDetail: additniolDetail,
      orgName: orgName,
    };
    setComponent(<FilteredModules items={data} />);
    setAllData(data);
    setHide(true);
  ...
  return (
    <div className="min-h-screen w-full px-32 ">
      {hide ? (
        ...
        <div className="bg-white my-10 min-h-auto p-5 mt-6 w-full  rounded border-[1px] border-zinc-200 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]">
          <div className="px-10 pt-8">
            {/* Heading section */}
            <div>
              <h1 className="font-semibold text-xl">Match Your Service</h1>
              <p className="text-sm mt-1 text-zinc-600">
                Please fill this form to get the better match
              </p>
            </div>
            ...
            <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      {orgCategory.map((curr: any) => {
                        return (
                          <SelectItem key={curr._id} value={curr.name} >{curr.name}</SelectItem>
                        );
                      })}
                    </SelectContent>
                  </Select>
                ...
                <div>
                  ...
                  <div className="mt-3 flex gap-2">
                    ...
                    <Input
                      ...
                      className="w-[700px]"
                      placeholder="Your Ammount Limit"
                    />
              ...
              {/* <div className="mt-8 flex flex-col gap-2">
                ...
                >
                  ...
                  <SelectContent>
                    {allOrg.map((curr: any) => {
                      return (
                        <SelectItem value={curr._id}>{curr.orgName}</SelectItem>
                      );
                    })}
                  </SelectContent>
                </Select>
              ...
              <Button
                onClick={handleRes}
                className="w-full mt-8 bg-zinc-800 hover:bg-zinc-600"
              >
                Match Your Service
              </Button>
              <Button
                ...
                variant={"outline"}
                className="w-full mt-2 hover:bg-zinc-600"
              >
                All Service
              </Button>
            </div>
